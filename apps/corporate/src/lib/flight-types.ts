...
export interface CreateBookingInput {
  ...
  /** Which cost center to charge — omit to use the employee's own default (see TravelPolicyService.resolveCostCenter). */
  costCenterId?: string;
...
export interface Booking {
  ...
  /** Present only for CORPORATE-channel bookings — which cost center this was charged to. */
